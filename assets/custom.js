...
document.addEventListener("DOMContentLoaded", function () {
  // Attach to all Rebuy product forms
  document.querySelectorAll('.section-rebuy-related-products form.quantity-form').forEach((form) => {
        ...
        fetch("/?sections=cart-drawer")
          ...
          .then(sections => {
            ...
            if (cartDrawer) {
              ...
              cartDrawer.classList.add("active");  // open drawer
